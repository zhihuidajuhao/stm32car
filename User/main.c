...
void TractionAndAvoidance()
{
	if(Left_Irobstacle_Get() == 1 && Right_Irobstacle_Get() == 1)
			{
				Robot_Traction();
			}
	else if(Left_Irobstacle_Get() == 1 && Right_Irobstacle_Get() == 0)
			{
				makerobo_Left(Speed,400);
				makerobo_run(Speed,400);
				makerobo_Right(Speed,800);
				if(Left_Irobstacle_Get() == 1 && Right_Irobstacle_Get() == 1)
					{
						Robot_Traction();
					}
	...
	else if(Left_Irobstacle_Get() == 0 && Right_Irobstacle_Get() == 1) 
			{
				makerobo_Right(Speed,400);
				makerobo_run(Speed,400);
				makerobo_Left(Speed,800);
				if(Left_Irobstacle_Get() == 1 && Right_Irobstacle_Get() == 1)
					{
						Robot_Traction();
					}
	...
	else if(Left_Irobstacle_Get() == 0 && Right_Irobstacle_Get() == 0) 
			{
				makerobo_brake(400);          
				makerobo_Spin_Right(Speed,900); 
				makerobo_run(Speed,400);
				makerobo_Spin_Left(Speed,1800);
				if(Left_Irobstacle_Get() == 1 && Right_Irobstacle_Get() == 1)
					{
						Robot_Traction();
					}
...
int main(void)
{
	...
	while (1)
	{
	  if(Key_GetNum() == 1)
		...
		switch(temp)
		{
			case 1: Digital_Display(1);TractionAndAvoidance();EXTI_DeInit();break;
